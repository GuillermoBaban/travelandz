function ErrorComponent({ setError }) {
  return (
    <div
      data-dismissible="alert"
      role="alert"
      className="font-regular flex w-full rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 px-4 py-4 text-base text-white absolute top-3 left-0 "
    >
